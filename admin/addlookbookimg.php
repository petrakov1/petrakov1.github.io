              ...
              <label>lookbook</label>
                ...
                <input class="uppercase button pink-back display-block " type="submit" value="добавить">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            if (isset($_POST['lookbook'])) {$lookbook= $_POST['lookbook'];}
                              include '../connect.php';
...
//                            $last_id = $conn->insert_id;
                            ...
                            $path = "../content/lookbook/$lookbook/"; // Upload directory
if (!file_exists($path)) {
...
//                                                echo $path.$name.".jpg";
                                                ...
                                                {
//                                                    //$last_id."_".$count
//                                                        $sql= "UPDATE `lookbook` SET `path` = 'content/lookbook/$lookbook/".$name."' WHERE `id` =".$lookbook;
//                                                        $conn->query($sql);
                                                     $sql = "INSERT INTO lookbook_images (`id`, `path`,`lookbook_id`) VALUES (NULL, 'content/lookbook/$lookbook/".$name."', '$lookbook')"; 
                                                            $conn->query($sql);
